...
HD_PWD='C:/NSCSCC/Project/ICache/ICache.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ICache.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ICache.tcl -notrace
