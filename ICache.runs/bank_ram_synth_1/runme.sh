...
HD_PWD='C:/NSCSCC/Project/ICache/ICache.runs/bank_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bank_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bank_ram.tcl
